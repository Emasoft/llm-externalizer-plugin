...
export async function runScoutJob(
  ...
  // IRON RULE (TRDD-8b6b3646): a PAID scout model must be validated (mass_scout is
  // rank 0 — any benchmark pass validates it), else refuse BEFORE the fan-out.
  // Exempt for ':free'. One check covers every fanned-out file call.
