# Detailed Leaderboard Workflow

## Table of Contents

- [Step 1: Parse the request](#step-1-parse-the-request)
- [Step 2: Find relevant benchmark datasets](#step-2-find-relevant-benchmark-datasets)
- [Step 3: Fetch top models from leaderboards](#step-3-fetch-top-models-from-leaderboards)
- [Step 4: Enrich with model metadata](#step-4-enrich-with-model-metadata)
- [Step 5: Filter and rank](#step-5-filter-and-rank)
